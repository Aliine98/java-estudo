...
public class TestaPerformanceListas {
    ...
    public static void main(String[] args) {
        ...
        tempoArrayList = pegaElementos(numerosArrayList);
        tempoLinkedList = pegaElementos(numerosLinkedList);

        System.out.println("Get da ArrayList demorou  " + tempoArrayList);
        System.out.println("Get da LinkedList demorou " + tempoLinkedList);
    }
    ...
    private static long pegaElementos(List<Integer> numeros) {
        long ini = System.currentTimeMillis();
        for (int i = 0; i < 5000; i++) {
            Integer integer = numeros.get(i);
        }
        long fim = System.currentTimeMillis();
        return fim-ini;
    }
